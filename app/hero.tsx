  ...
  return (
    <div className="relative z-20 mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-36">
      ...
      <motion.h1
        ...
        className={`mb-3 text-center text-3xl font-bold leading-tight text-zinc-50 sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight lg:text-7xl lg:leading-tight ${furoreFont.className}`}
      >
        Blokchain Based Nft Book Marketplace
      </motion.h1>
      <motion.p
        initial={{
          y: 25,
      ...
      >
        Take our starter subscription or monthly subscription and enjoy
        unlimited readout on a wide variety of books available with the cutting
        edge technology of blockchain.
      </motion.p>
      <motion.div
        initial={{
          y: 25,
...
const SplashButton = ({ children, className, ...rest }: ButtonProps) => {
  return (
    <button
      className={twMerge(
        "rounded-md bg-gradient-to-br from-orange-400 to-orange-600 px-4 py-2 text-zinc-50 ring-2 ring-blue-500/50 ring-offset-2 ring-offset-zinc-950 transition-all hover:scale-[1.02] hover:ring-transparent active:scale-[0.98] active:ring-blue-500/70",
        className
      )}
      {...rest}
    >
