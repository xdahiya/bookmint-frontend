...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[80vh] md:min-h-[180vh]  flex flex-col items-center py-0 md:py-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.45] sm:scale-50"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute inset-0 bg-muted/5 rounded-lg" />
        {/* <iframe
          width="560"
          height="315"
          src="https://www.youtube-nocookie.com/embed/qt1equGhkQE?si=gREL37qv2TMprSA8&amp;start=5"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerPolicy="strict-origin-when-cross-origin"
          className="object-contain object-center absolute rounded-lg inset-0 h-full w-full bg-muted/5"
          allowFullScreen
        ></iframe> */}
        <Image
          src={src as string}
